package org.bagab.entity.relationships.many2many_bi.test;


import org.bagab.entity.relationships.many2many_bi.model.Employee;
import org.bagab.entity.relationships.many2many_bi.model.Project;
import org.bagab.entity.relationships.many2many_bi.service.ManyToManyBiService;
...
public class ManyToManyBiTest {
    ...
    @EJB private ManyToManyBiService svc;
